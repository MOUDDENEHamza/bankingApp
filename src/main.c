...
int main(int argc, char *argv[]) {
	...
	//parse_json(head);//Parse the json file containing the client data
	choose_feature(s, &flag); //Choose the feature you want to run
	while (exit){
		handle_menu(s, client, &flag, &exit, &index, passwd, id, &log_in); //Define the function handling the main menu
